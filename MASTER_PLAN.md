...
### Main público (GitHub)
- `main` = `d36791c` (18/09 — PRs #66/#67/#68: fechamento final documental +
  **Fase 1 — GitHub Pages + cron 06:00 America/Sao_Paulo**): **CI verde —
  24/24 scripts, 1.062 checks, 0 falhas**; ranking público em
  https://rios-vini.github.io/internship-finder/ (branch `gh-pages`, só
  `index.html`, gerada por `scripts/publish_pages.py`); cron diário `0 9 * * *`
