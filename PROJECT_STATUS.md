...
- **P2 is complete** (#10–#17 done — see Completed). Next backlog items:
  - **P3 #20**: small ACH validations (`--timeout`/`--limit`, `remote` vs field, `country` vs `country_iso`, CSV decision, date parsing if measured, `EUROPE_COUNTRIES`/BY docs)
